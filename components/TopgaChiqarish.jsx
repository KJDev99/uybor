...
const TopgaChiqarish = ({ text, title }) => {
  ...
  return (
    <div className="flex flex-col mt-[10px]">
      {text || title ? (
        <>
          <h2 className="text-qora text-3xl font-semibold ml-[25px] mb-5">
            {title}
          </h2>
          <p className="text text-qora mb-[30px] ml-[25px]">{text}</p>
        </>
      ) : (
        <>
          <h2 className="text-qora text-xl font-semibold">Topga chiqarish</h2>
