    ...
    <div className="">
      ...
      <div className=" rounded-[10px] md:bg-white p-[30px] flex items-center justify-center flex-col mb-[50px]">
        ...
        <div className="flex mb-20">
          <button className="h-[44px] w-[173px] max-md:w-[140px]  border border-kulrang text-kulrang text-lg rounded-[10px] mx-5 hover:border-logoKok hover:bg-logoKok hover:text-white transition-all">
            Yo'q
          </button>
          <button className="h-[44px] w-[173px] max-md:w-[140px] border border-kulrang text-kulrang text-lg rounded-[10px] mx-5 hover:border-logoKok hover:bg-logoKok hover:text-white transition-all">
            Ha
